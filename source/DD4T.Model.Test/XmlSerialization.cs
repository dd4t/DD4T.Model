...
namespace DD4T.Model.Test
{
    ...
    public class XmlSerialization : BaseSerialization
    {
        ...
        public static void SetupTest(TestContext context)
        {
            ...
            testInstance.DeserializePageXmlDXA();
        }
