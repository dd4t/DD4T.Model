...
namespace DD4T.Serialization
{
    ...
    {
        public abstract string Serialize<T>(T input) where T : ContentModel.Contracts.IModel;

        public abstract T Deserialize<T>(string input) where T : ContentModel.Contracts.IModel;
